      ...
      <div className="flex justify-center items-center min-h-screen p-4">
        <div className="flex flex-col md:flex-row justify-center items-center bg-slate-100 dark:bg-gray-800 shadow-lg p-6 md:p-10 rounded-lg space-y-6 md:space-y-0 md:space-x-12 w-full max-w-4xl">
          ...
          <div className="flex flex-col items-center w-full md:w-auto">
            ...
            <input
              className="w-full md:w-72 p-2 md:p-4 h-10 md:h-12 border-2 border-gray-400 dark:border-gray-600 mb-4 rounded-md text-black"
            ...
            />
            <textarea
              className="w-full md:w-72 p-2 md:p-4 h-32 md:h-40 border-2 border-gray-400 dark:border-gray-600 mb-4 rounded-md text-black"
              placeholder="Message"
              value={message}
